...
@section('content')
    <div class="row ">
        <div class="col-4 my-4 offset-1">
            <h3 class="text-center mb-2">Create Post</h2>
                <form method="post" action="{{ route('admin#createPost') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-11">
                            <textarea name="postDescription" class="form-control" id="" cols="30" rows="7">{{ old('postDescription') }}</textarea>
                    ...
                    <div class="form-group row mt-3">
                        ...
                        <div class="col-11">
                            <input type="file" name="postImage" value=""
                                class="form-control form-control-lg @error('postImage') is-invalid @enderror"
                            ...
                            <select name="postCategoryId" id="" class="form-control">
                                ...
                                @foreach ($categories as $category)
                                    <option value="{{ $category->id }}"
                                        {{ old('postCategoryId') == $category->id ? 'selected' : '' }}>
                                        {{ $category->title }}
                                    </option>
                                @endforeach
                            </select>
